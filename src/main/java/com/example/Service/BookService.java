...
public class BookService {
    ...
    public void addNewBook(String bookId ,String bookName, String authorNameTxt, String authorNameCb, String categoryTxt, String categoryCb, int quantityText, LocalDate publishDate) throws SQLException {
...
//        System.out.println(findIdByName("author_id",bookDTO.getAuthorName(), "author", "name"));
        ...
        String insertNewBookSql = "insert into book(book_id ,name, category_id, author_id, amount, create_day) values('" + bookId + "','" + bookDTO.getBookName() + "', " + categoryId + "," + authorId +"," + bookDTO.getQuantity() + ",'" + bookDTO.getPublishDate() + "')";
